...
<html lang="en">
  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar" class="col-2">
      <div class="p-3 pt-5">
        <h4>Menu</h4>
        <ul class="nav nav-pills nav-fill nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{url('/home')}}">Arsip</a>
          </li>
          <li class="nav-item">
    ...
    <div id="content" class="p-md-5 col-10">
      ...
      <div class="card-body table-full-width ">
                ...
                <tr>
                  ...
                  <td>
                    <div class="col">
                      ...
                      <a download="{{$s->judul}}" href="{{url('/download/').'/'.$s->id}}" title='Download pdf document'><button class="btn btn-warning" >Unduh</button></a>
                      <a href="{{url('/show')}}{{'/'.$s->id}}"> <button type="button" class="btn btn-info">Lihat >></button></a>
                    </div>
                  </td>  
                </tr>
                @endforeach
          ...
          <div class="pt-2">
            <a href="{{url('create')}}"><button type="button" class="btn btn-primary">Arsipkan Surat</button></a>
          </div>
